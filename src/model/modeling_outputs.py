...
DUAL_LAST_HIDDEN_STATE = Union[torch.FloatTensor, Tuple[torch.FloatTensor, torch.FloatTensor]]
DUAL_ATTENTIONS = Union[Tuple[torch.FloatTensor], Tuple[torch.FloatTensor, torch.FloatTensor]]
...
class BaseModelOutput(ModelOutput):
    ...
    last_hidden_state: DUAL_LAST_HIDDEN_STATE
    hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    attentions: Optional[Tuple[torch.FloatTensor, torch.FloatTensor]] = None
