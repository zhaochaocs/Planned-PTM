...
cache_path = '/playpen-ssd/chao/tools/transformers'
...
def main():
    ...
    parser.add_argument("--data_dir",
                        default="../dataset/commongen_data/commongen2",
                        type=str,
    ...
    parser.add_argument("--output_dir",
                        default="../../../output/train_planned_bart",
                        type=str,
                        help="The output directory where the model predictions and checkpoints will be written.")
    parser.add_argument("--log_dir",
                        default="../../../log/train_planned_bart",
                        type=str,
